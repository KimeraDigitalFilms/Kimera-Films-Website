...
function About() {
  return (
    <div className="screen-padding mb-44">
      ...
      <div className="flex flex-col text-2xl font-thin text-secondary1">
        ...
        heads.
        <div className="mt-10 flex flex-nowrap items-center">
          <div className="w-3/4 text-2xl font-thin text-secondary1">
            ...
            <br />
            <br />
            Our process begins with uncovering the essence of your idea or
            brand, crafting it into a compelling and strategic narrative, and
            expertly executing your brand vision. Each step of this journey is
            fueled by passion, innovation, and an unwavering commitment to
            distinction.
          </div>
          <Canvas className="about3d">
            <ModelElement />
