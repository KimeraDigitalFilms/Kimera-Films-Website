...
function LogoGimmick() {
  ...
  let translateY = useTransform(scrollYProgress, [0, 0.6], ["0px", "100vh"]);
  let scale = useTransform(scrollYProgress, [0, 0.6], [1, 2.1]);
  let rotate = useTransform(scrollYProgress, [0, 0.6], ["0deg", "90deg"]);

  let textX = useTransform(scrollYProgress, [0.6, 0.8], ["100%", "-25%"], {
    ease: easeOut,
  });
  let textY = useTransform(scrollYProgress, [0, 0.6], ["0px", "100vh"]);
  //   useEffect(() => {
  //     setYOffset(
  ...
  return (
    <div
      id="logoGimmick"
      ref={ref}
      className="h-[230vh]  overflow-hidden relative"
    >
      <motion.h1
